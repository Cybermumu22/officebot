...
<!-- Your own notes go OUTSIDE this block. Everything between the two
     pocket-deck markers is regenerated by termux-setup.sh on every run;
     anything above or below them is left alone. Put your projects and
